...
import getUserRoles from '@salesforce/apex/RemainEducationController_copy.getUserRoles';
import getAllEmployeeRemain from '@salesforce/apex/RemainEducationController_copy.getAllEmployeeRemain';
import getAllEmployeeInProgress from '@salesforce/apex/RemainEducationController_copy.getAllEmployeeInProgress';
import getRemainEducation from '@salesforce/apex/RemainEducationController_copy.getRemainEducation';
import getInProgressEducation from '@salesforce/apex/RemainEducationController_copy.getInProgressEducation';
import getName from '@salesforce/apex/RemainEducationController_copy.getName';
import getAllMenteeRemain from '@salesforce/apex/RemainEducationController_copy.getAllMenteeRemain';
import getAllMenteeInProgress from '@salesforce/apex/RemainEducationController_copy.getAllMenteeInProgress';
import CustomDatatable from 'c/customDatatable';


export default class parentEducationSearch extends NavigationMixin(LightningElement) {
    @track isRole = false;
    @track isCheck = false;
    ...
    fetchAllEmployeeData() {
        ...
        .then((result) => {
            // 결과 데이터를 LWC 데이터 테이블에 맞게 매핑
            this.data = result.map((program) => ({
                id: program.id,
                programName: program.programName,
                category: program.category,
                employeeNames: program.employeeNames // HTML 문자열 그대로 사용
            }));
    ...
    renderedCallback() {
        // 링크에 이벤트 리스너 추가
        this.template.querySelectorAll('.employee-link').forEach(link => {
            link.addEventListener('click', this.handleNameClick.bind(this));
        });
    }
